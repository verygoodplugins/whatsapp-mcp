...
func newRESTMux(client *whatsmeow.Client, messageStore *MessageStore, port int, token string) *http.ServeMux {
...
func startRESTServer(client *whatsmeow.Client, messageStore *MessageStore, port int, token string) {
	handler := newRESTMux(client, messageStore, port, token)
...
connectionSuccess:
	...
	startRESTServer(client, messageStore, port, bridgeToken)
