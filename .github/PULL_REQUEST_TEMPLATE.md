...
- [ ] This change fits the [`ROADMAP.md`](https://github.com/DynamicDevices/whatsapp-mcp/blob/main/ROADMAP.md) "in scope" list, **or** I've opened an issue first to discuss
